...
var (
	...
	SupportedAlgorithms = keyring.SigningAlgoList{EthSecp256k1, cosmoshd.Secp256k1}
	...
	SupportedAlgorithmsLedger = keyring.SigningAlgoList{EthSecp256k1, cosmoshd.Secp256k1}
)
...
func EthSecp256k1Option() keyring.Option {
	return func(options *keyring.Options) {
		options.SupportedAlgos = SupportedAlgorithms
		options.SupportedAlgosLedger = SupportedAlgorithmsLedger
		options.LedgerCreateKey = func(key []byte) types.PubKey { return &PubKey{Key: key} }
