...
func TestBatchReconstruction(t *testing.T) {
	l1ChainConfig := &ChainConfig{
		...
		Image:          ibc.DockerImage{Repository: "ghcr.io/initia-labs/initiad", Version: "v1.3.1", UIDGID: "1000:1000"},
		Bin:            "initiad",
		Bech32Prefix:   "init",
		Denom:          "uinit",
		Gas:            "auto",
	...
	l2ChainConfig := &ChainConfig{
		ChainID:        "minimove-2",
		Image:          ibc.DockerImage{Repository: "ghcr.io/initia-labs/minimove", Version: "v1.1.10", UIDGID: "1000:1000"},
		Bin:            "minitiad",
		Bech32Prefix:   "init",
		Denom:          "umin",
		Gas:            "auto",
