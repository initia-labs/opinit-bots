module github.com/initia-labs/opinit-bots/e2e
...
replace (
	...
	github.com/initia-labs/opinit-bots => ../

	github.com/strangelove-ventures/interchaintest/v8 => github.com/initia-labs/interchaintest/v8 v8.0.0-20250311032017-0c34b5ad80d1
