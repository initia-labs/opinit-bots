// this is from "github.com/cometbft/cometbft/rpc/client"
...
func (c *baseRPCClient) BlockBulk(ctx context.Context, start *int64, end *int64) ([][]byte, error) {
	...
	_, err := c.caller.Call(ctx, "block_bulk", params, result)
	if err != nil {
		return nil, err
	}
...
func (c *baseRPCClient) CustomTx(ctx context.Context, hash []byte, prove bool) (*ctypes.ResultTx, error) {
	result := new(clienttypes.ResultTx)
	params := map[string]interface{}{
		"hash":  hash,
		"prove": prove,
	}
